...
void cnla_main(int argc, char *argv[]);
void cnla_usage(void);
void cnla_getflag(char *f,char *f1, int *i);
void cnla_init(char c);
void cnla_call(void);
...
void combine_main(int argc, char *argv[]);
void combine_usage(void);
void combine_getflag(char *f,char *f1, int *i);
void combine_init(char c);
void combine_call(void);
...
/* ************************************************************* */
	...
	clan_main[CNLA]			= cnla_main;
	clan_usage[CNLA]		= cnla_usage;
	clan_getflag[CNLA]		= cnla_getflag;
	clan_init[CNLA]			= cnla_init;
	clan_call[CNLA]			= cnla_call;
	...
	clan_main[TEMP02]		= combine_main;
	clan_usage[TEMP02]		= combine_usage;
	clan_getflag[TEMP02]	= combine_getflag;
	clan_init[TEMP02]		= combine_init;
	clan_call[TEMP02]		= combine_call;
